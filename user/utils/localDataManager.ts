/**
 * Local Data Manager
 * Manages booking requests using browser's localStorage
...
const STORAGE_KEY = 'bchs_booking_requests';

/**
 * Get all booking requests from localStorage
 */
...
/**
 * Add a new booking request to localStorage
 */
export function addRequest(request: BookingRequest): void {
  try {
 ...
 */
export function updateRequest(id: string, updates: Partial<BookingRequest>): void {
  try {
    const requests = getAllRequests();
 ...
 */
export function getRequestsByDate(date: string): BookingRequest[] {
  const requests = getAllRequests();
 ...
 */
export function getRequestsByRoom(roomId: string): BookingRequest[] {
  const requests = getAllRequests();
